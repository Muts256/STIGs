<#
.SYNOPSIS
    This PowerShell script sets Audit Other Logon/Logoff Events (Success).
...
#   2. Enable success auditing for Other Logon/Logoff Events
#   3. Verify effective configuration
#
# NOTE:
#   A system reboot is REQUIRED for persistence and Nessus compliance.
# ============================================================
...
Write-Output "Starting WN11-AU-000560 remediation..."
...
# ------------------------------------------------------------
# Step 2: Enable SUCCESS auditing for Other Logon/Logoff Events
# ------------------------------------------------------------
$subcategory = "Other Logon/Logoff Events"

AuditPol.exe /set /subcategory:"$subcategory" /success:enable /failure:disable

Write-Output "Success auditing enabled for Other Logon/Logoff Events."
...
Write-Output "WN11-AU-000560 remediation applied."
